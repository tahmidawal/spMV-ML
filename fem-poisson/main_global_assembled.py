...
if __name__ == "__main__":
    ...
    assembled_csr_mat = global_assembl_poisson.poisson.assemble_global(p_order, all_pts_gll_x, all_pts_gll_y, all_pts_gll_z, e_to_n,
                                      refel.gauss_w_3d, refel.gll_to_gauss_1d, refel.d_gauss_1d)



    matvec_compiled = poisson_utils.preprocess.compile_for_inputs(global_assembl_poisson.poisson.sparse_matvec, [], assembled_csr_mat, u_exact, bdry_indices)

    print(f"order : {p_order}\t est. (assembled) matvec cost: {matvec_compiled.cost_analysis()['flops']}")


    print("compilation started..")

    nvtx.push_range("solver_compiling")
    solve_poisson_compiled = poisson_utils.preprocess.compile_for_inputs(global_assembl_poisson.poisson.solve_poisson, (0,), 
                                                                         p_order, assembled_csr_mat, all_pts_gll_x, all_pts_gll_y, all_pts_gll_z, e_to_n, e_to_n_sorted, e_to_n_sort_idx, bdry_indices,
    ...
    u_numeric = solve_poisson_compiled(assembled_csr_mat, all_pts_gll_x, all_pts_gll_y, all_pts_gll_z, e_to_n, e_to_n_sorted, e_to_n_sort_idx, bdry_indices,
