...
def conjugate_gradient_unrolled(p_order, node_coords_x, node_coords_y, node_coords_z, 
    ...
    # Initial residual
    r0 = b - mat_free_poisson_v2.poisson.mat_free_matvec(p_order, node_coords_x, node_coords_y, node_coords_z, 
    ...
    def single_step(i, rs_old, x, r, p):
        Ap = mat_free_poisson_v2.poisson.mat_free_matvec(p_order, node_coords_x, node_coords_y, node_coords_z, 
