...
import mat_free_poisson.solver
...
def elem_stiffness_matvec(p_order, gll_node_coords_x, gll_node_coords_y, gll_node_coords_z, vec_u_section, 
    ...
    gauss_node_coords_x, gauss_node_coords_y, gauss_node_coords_z  = poisson_utils.geometry.transform_elem_coords(p_order, gll_node_coords_x, gll_node_coords_y, gll_node_coords_z, gll_to_gauss_1d)
    ...
    QxT_mult3 = poisson_utils.tensor.ABCx(gll_to_gauss_1d.T, 
                                       gll_to_gauss_1d.T, 
                                       d_gauss_1d.T, fac_mult_3, p_order+1)

    QyT_mult4 = poisson_utils.tensor.ABCx(gll_to_gauss_1d.T, 
                                       d_gauss_1d.T, 
                                       gll_to_gauss_1d.T, fac_mult_4, p_order+1)

    QxT_mult5 = poisson_utils.tensor.ABCx(gll_to_gauss_1d.T, 
                                       gll_to_gauss_1d.T, 
                                       d_gauss_1d.T, fac_mult_5, p_order+1)

    QzT_mult6 = poisson_utils.tensor.ABCx(d_gauss_1d.T, 
                                       gll_to_gauss_1d.T, 
                                       gll_to_gauss_1d.T, fac_mult_6, p_order+1)

    QzT_mult7 = poisson_utils.tensor.ABCx(d_gauss_1d.T, 
                                       gll_to_gauss_1d.T, 
                                       gll_to_gauss_1d.T, fac_mult_7, p_order+1)

    QyT_mult8 = poisson_utils.tensor.ABCx(gll_to_gauss_1d.T, 
                                       d_gauss_1d.T, 
                                       gll_to_gauss_1d.T, fac_mult_8, p_order+1)
...
def mat_free_matvec(p_order, node_coords_x, node_coords_y, node_coords_z, 
    ...
    v_elem_stiffness_matvec = jax.vmap(elem_stiffness_matvec, in_axes=(None, 0, 0, 0, 0, None, None, None))
    vec_Au_scattered = jax.lax.optimization_barrier(v_elem_stiffness_matvec(p_order, 
...
def solve_poisson(p_order, node_coords_x, node_coords_y, node_coords_z, e_to_n, e_to_n_sorted, e_to_n_sort_idx, boundary_indices,
    ...
    u_numeric = mat_free_poisson.solver.conjugate_gradient_unrolled(p_order, node_coords_x, node_coords_y, node_coords_z, e_to_n, e_to_n_sorted, e_to_n_sort_idx, boundary_indices,
